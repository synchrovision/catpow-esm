...
import { StepSelect as StepSelectComponent } from "catpow/component";
...
export const StepSelect = (props) => {
	...
	return (
		<div className={className}>
			<StepSelectComponent options={options} multiple={agent.getMergedSchemaForInput().type === "array"} onChange={onUpdate} />
		</div>
	);
};
