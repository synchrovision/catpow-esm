...
import { getSubSchema } from "./getSubSchema.js";
...
export const getResolvedSchema = (schema, rootSchema) => {
	...
	if (schema.hasOwnProperty("@type")) {
		Object.assign(resolvedSchema, getResolvedSchema(getSubSchema("#/$defs/" + schema["@type"], schema, rootSchema), rootSchema));
	}
	if (schema.hasOwnProperty("$ref")) {
		Object.assign(resolvedSchema, getResolvedSchema(getSubSchema(schema.$ref, schema, rootSchema), rootSchema));
	}
	if (items != null) {
